...
public class DataPreparation{
	...
	public static List<Object> getCountriesData() {
		...
		list.add(new CountryLocale(5L, 2L, CountryIds.USD_COUNTRY_ID, "USj", "United States of America - jp"));
		list.add(new CountryLocale(6L, 2L, CountryIds.JPY_COUNTRY_ID, "JPj", "Japan - jp"));
		list.add(new CountryLocale(7L, 2L, CountryIds.THAI_COUNTRY_ID, "THj", "Thailand - jp"));

		//Countries in japanies
		list.add(new CountryLocale(8L, 3L, CountryIds.USD_COUNTRY_ID, "USh", "United States of America - th"));
		list.add(new CountryLocale(9L, 3L, CountryIds.JPY_COUNTRY_ID, "JPh", "Japan - th"));
		list.add(new CountryLocale(10L, 3L, CountryIds.THAI_COUNTRY_ID, "THh", "Thailand - th"));
	...
	public static List<Object> getCurrenciesData() {
		...
		list.add(new CurrencyLocale(5L, 2L, CurrencyIds.USD, "Dollor - jp"));
		list.add(new CurrencyLocale(6L, 2L, CurrencyIds.JPY, "Yen - jp"));
		list.add(new CurrencyLocale(7L, 2L, CurrencyIds.THB, "Baht - jp"));

		// Currencies in Thai
		list.add(new CurrencyLocale(8L, 3L, CurrencyIds.USD, "Dollor - th"));
		list.add(new CurrencyLocale(9L, 3L, CurrencyIds.JPY, "Yen - th"));
		list.add(new CurrencyLocale(10L, 3L, CurrencyIds.THB, "Baht - th"));
	...
	public static List<Object> getMasterWalletsData(){
		...
		list.add(new MasterAmountWallet(4L, 4L, 0.0));
		...
		list.add(new MasterFeeWallet(4L, 4L, 0.0));
		...
		list.add(new MasterTaxWallet(4L, 4L, 0.0));
	...
	public static List<Object> getErrorCodes(){
		...
		list.add(new ErrorCode(11L, "M0011", "Account already login"));
		list.add(new ErrorCode(12L, "M0012", "Login account deactivated"));
		...
		list.add(new ErrorCode(15L, "M0015", "Joint card account exist with authid"));
		list.add(new ErrorCode(16L, "M0016", "Duplicate card account"));
		list.add(new ErrorCode(17L, "M0017", "Card fraud check failed"));
		list.add(new ErrorCode(18L, "M0018", "Failed to retrieve account details! Please try again"));
		...
		list.add(new ErrorCode(21L, "M0021", "Failed to save card details! Please try again"));
		
		/*View wallet balance*/
		list.add(new ErrorCode(22L, "M0022", "Unable retrieve the list of wallet balances"));
		list.add(new ErrorCode(23L, "M0023", "No transaction record found"));
		
		/*Login and logout*/
		list.add(new ErrorCode(24L, "M0024", "MSISDN number is should not be empty"));
		list.add(new ErrorCode(25L, "M0025", "SIM number should not be empty"));
		list.add(new ErrorCode(26L, "M0026", "IMEI number should not be empty"));
		list.add(new ErrorCode(27L, "M0027", "User mobile does not matches reg number"));
		list.add(new ErrorCode(28L, "M0028", "Failed to register your mobile wallet"));
		...
		list.add(new ErrorCode(31L, "M0031", "Card verification failed"));
		list.add(new ErrorCode(32L, "M0032", "Account failed to retrieve"));
		list.add(new ErrorCode(33L, "M0033", "Wrong card information. Please check your inputs"));
		list.add(new ErrorCode(34L, "M0034", "Edit card failed"));
		
		// Added for Transaction
		list.add(new ErrorCode(35L, "M0035","Self transfer failed"));
		list.add(new ErrorCode(36L, "M0036","User wallet not having enough balance"));
		list.add(new ErrorCode(37L, "M0037","Over limit threshold amount"));
		list.add(new ErrorCode(38L, "M0038","User does not have wallets"));
		list.add(new ErrorCode(39L, "M0039","Not an authorized user to transfer money"));
		list.add(new ErrorCode(40L, "M0040","Not allowed email id and please try with correct email id"));
		list.add(new ErrorCode(41L, "M0041","Send money customer email id not registered"));
		list.add(new ErrorCode(42L, "M0042","Send money merchant email id not registered"));
		list.add(new ErrorCode(43L, "M0043","Self transferred transaction successful"));
		
		/*P2P Transaction*/
		list.add(new ErrorCode(44L, "M0044","Error occurred for getting wallets"));
		list.add(new ErrorCode(45L, "M0045", "Unknown error occurred"));
		list.add(new ErrorCode(46L, "M0046", "User has deleted"));
		list.add(new ErrorCode(47L, "M0047", "User has locked"));
		list.add(new ErrorCode(48L, "M0048", "User has rejected"));
		list.add(new ErrorCode(49L, "M0049", "User has inactive"));
		list.add(new ErrorCode(50L, "M0050", "User not approved"));
		list.add(new ErrorCode(51L, "M0051", "Send money customer email id not registered"));
		list.add(new ErrorCode(52L, "M0052", "Send money user email exists"));
		list.add(new ErrorCode(53L, "M0053", "Transaction failed"));
		list.add(new ErrorCode(54L, "M0054", "Transaction successful"));
		list.add(new ErrorCode(55L, "M0055", "Send money merchant email id not registered"));
		list.add(new ErrorCode(56L, "M0056", "Email merchant not registered error"));
		...
		list.add(new ErrorCode(59L, "M0059", "Account set default error message"));
		list.add(new ErrorCode(60L, "M0060", "Unable to delete default account"));
		list.add(new ErrorCode(61L, "M0061", "Not verified and verified account required"));
		list.add(new ErrorCode(62L, "M0062", "Account deleted successfully"));
		list.add(new ErrorCode(63L, "M0063", "Card registered successfully"));
		list.add(new ErrorCode(64L, "M0064", "Existing account added again"));
		list.add(new ErrorCode(65L, "M0065", "Card updated successfully"));
		list.add(new ErrorCode(66L, "M0066", "Account deleted successfully"));
		list.add(new ErrorCode(67L, "M0067", "Account set default successfully"));
		list.add(new ErrorCode(68L, "M0068", "Accounts size exceeds"));
		list.add(new ErrorCode(69L, "M0069", "Accounts size unknown. Please try again"));
		...
		list.add(new ErrorCode(72L, "M0072", "Not authorized transaction"));
		list.add(new ErrorCode(73L, "M0073", "Card verified successfully"));
		
		list.add(new ErrorCode(74L, "M0074","Failed to retrieve account details reload money"));
		...
		list.add(new ErrorCode(79L, "M0079","Unknown pg response"));
		list.add(new ErrorCode(80L, "M0080","Invalid account id"));
		list.add(new ErrorCode(81L, "M0081","Invalid amount format"));
		list.add(new ErrorCode(82L, "M0082","Account type is not a card"));
		list.add(new ErrorCode(83L, "M0083","Account is not verified"));
		list.add(new ErrorCode(84L, "M0084","Invalid cvv format"));
		
		list.add(new ErrorCode(85L, "M0085","User not yet login"));
		list.add(new ErrorCode(86L, "M0086","Invalid session"));
		list.add(new ErrorCode(87L, "M0087","Invalid user access"));
		list.add(new ErrorCode(88L, "M0088","User not registers as mobile wallet"));
		list.add(new ErrorCode(89L, "M0089","Wrong account details"));
		list.add(new ErrorCode(90L, "M0090","Unable edits default account"));
		...
		list.add(new ErrorCode(94L, "M0094","User type should not be empty"));		
		list.add(new ErrorCode(95L, "M0095","Password should not be empty"));
		list.add(new ErrorCode(96L, "M0096","From towallet should not be empty"));
		list.add(new ErrorCode(97L, "M0097","From towallet should not be empty string"));
		list.add(new ErrorCode(98L, "M0098","From towallet should not be same"));
		list.add(new ErrorCode(99L, "M0099","From towallet could not support"));
		list.add(new ErrorCode(100L, "M00100","Amount should not be empty"));
		...
		list.add(new ErrorCode(103L, "M00103","Unable to retrieve list of currency"));
		list.add(new ErrorCode(104L, "M00104","Unable to retrieve destination types"));
		list.add(new ErrorCode(105L, "M00105","Unable to retrieve type of cards"));
		list.add(new ErrorCode(106L, "M00106","User authentication successful"));
		...
		list.add(new ErrorCode(112L, "M00112","MPIN generated successfully"));
		...
		list.add(new ErrorCode(123L, "M00123", "Forgot mpin failed"));
		...
		list.add(new ErrorCode(128L, "M00128", "Old mpin new mpin should not be same"));
		list.add(new ErrorCode(129L, "M00129", "Mobile wallet account exists generate mpin"));
		list.add(new ErrorCode(130L, "M00130", "Unable to process msg"));
		list.add(new ErrorCode(131L, "M00131", "Query sent successfully"));
		list.add(new ErrorCode(132L, "M00132", "Query sent failed"));
		list.add(new ErrorCode(133L, "M00133", "Feedback query type not support"));
		...
		list.add(new ErrorCode(158L, "M00162", "Please enter correct old mpin "));
		list.add(new ErrorCode(159L, "M00163", "Secret qa success"));
		list.add(new ErrorCode(160L, "M00164", "Security question and answer not belongs to this user"));
		list.add(new ErrorCode(161L, "M00165", "Please enter the correct registerd mobile number"));
        return list;
	}
